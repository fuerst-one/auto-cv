  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-950/70 p-5 shadow-lg shadow-emerald-500/5">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-black/50 px-3 py-1 text-[0.65rem] font-mono uppercase tracking-[0.3em] text-emerald-300 transition hover:border-emerald-400/40 hover:text-emerald-100"
